...
public class BlackJack {
    ...
    static void jugarMultiplayer(ServerSocket servidor, Socket socket, boolean esServidor) {
        ...
        try {
            ...
            socket.setSoTimeout(60000); // 60 segundos timeout para conexión inicial
            ...
            while (continuarJugando) {
                try {
                    if (esServidor) {
                        ...
                        System.out.println("[DEBUG] Enviando al cliente: CARTAS:" + cartasSerializadas);
                    ...
                    while (true) {
                        ...
                        try {
                            ...
                            System.out.println("[DEBUG] Servidor recibió del cliente: " + mensajeCliente);
                        } catch (SocketTimeoutException e) {
                        ...
                        if (mensajeCliente == null) {
                            System.out.println("\n[DEBUG] Cliente desconectado - readLine() retornó null");
                    ...
                    System.out.println("[DEBUG] Cliente recibió: " + cartasMsg);
                    ...
                    if (!cartasMsg.startsWith("CARTAS:")) {
                        System.out.println("[ERROR] Mensaje inesperado del servidor: " + cartasMsg);
                        continuarJugando = false;
                        break;
                    }
                    
                    Hand manoCliente = deserializarMano(cartasMsg.split(":", 2)[1]);
            ...
            // Cerrar recursos (EXCEPTO el scanner principal)
            try {
                if (in != null) in.close();
                if (out != null) out.close();
                // NO cerrar scanner aquí - pertenece al main
